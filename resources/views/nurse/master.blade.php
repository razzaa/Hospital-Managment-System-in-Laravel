      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <a href="{{route('nurse')}}" class="nav-link ">
            ...
            <li class="nav-item has-treeview">
              <a href="{{url('nurse_doctor_view')}}" class="nav-link">
            ...
            <li class="nav-item has-treeview">
              <a href="{{url('nurse_patient_view')}}" class="nav-link">
            ...
            <li class="nav-item has-treeview">
            <a href="{{url('nurse_bedward_view')}}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ url('/display_nurse_profile') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Profile</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('nurse_profilepicture')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Change Picture</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('nurse_changepassword')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Change Password</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('update_nurse_profile')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Edit Profile</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
            <a href="{{url('nurse_blood_bank_view')}}" class="nav-link">
            ...
            <li class="nav-item">
            <a href="{{url('nurse_noticeboard_view')}}" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0 text-dark">Nurse Dashboard</h3>
          </div><!-- /.col -->
