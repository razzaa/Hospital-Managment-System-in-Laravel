                  ...
                  <div class="row">
                      ...
                      <div class="col-md-8 col-xs-12 col-sm-6 col-lg-8">
                          ...
                          <ul class="container details">
                            ...
                            <li><p><span class="glyphicon glyphicon-envelope one" style="width:50px;"></span>{{$da->phone_number}}</p></li>
                            <li><p><span class="glyphicon glyphicon-map-marker one" style="width:50px;"></span>{{$da->permanent_address}}</p></li>
