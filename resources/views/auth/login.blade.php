		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				...
				@csrf
					...
					<input id="email" class="input100" type="email" placeholder="Email" class=" @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
					...
					<div class="text-center">
						...
						<a href="{{ route('register') }}" class="txt2 hov1" >	Sign up</a>
